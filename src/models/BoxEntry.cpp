...
BoxEntry::BoxEntry(const std::string& user, int64_t ts, int id, int shelf)
...
void BoxEntry::set_shelf_id(int shelf) {
    shelf_id = shelf;
}
...
void BoxEntry::put(const std::string& user, int shelf) {
...
int BoxEntry::get_shelf_id() const {
    return shelf_id;
}